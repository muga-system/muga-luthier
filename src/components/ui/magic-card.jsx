...
export function MagicCard({
  ...
  const reset = useCallback(() => {
    ...
    const closestEdge = Object.entries(distances).reduce((closest, [edge, distance]) =>
      distance < closest.distance ? { edge, distance } : closest, { edge: "left", distance: distances.left }).edge
